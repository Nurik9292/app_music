...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Создание Плейлиста</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                ...
                <div class="row">
                    <div class="block_one">
                        ...
                        <input type="text" class="form-control" id="title_tm" placeholder="Введите Название" name="title_tm">
                        @error('title_tm')
                      ...
                      <div class="block_one">
                        ...
                        <input type="text" class="form-control" id="title_ru" placeholder="Введите Название" name="title_ru">
                        @error('title_ru')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                      </div>
